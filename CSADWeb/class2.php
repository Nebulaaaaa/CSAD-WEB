...
<header class="header">
  ...
  <main>
    <div class="class-upper-container">
        ...
        <div class="class-catchphrase">Catch up with the kids</div>
    ...
    <div class="class-lower-container">
        ...
        <div class="button-container">
            <input type="button" class="enroll-now-2" value="Enroll Now">
        </div>
    </div>
    <div class="class-card">
        <div class="img-gallery">
            <img src="" alt="MobileApplications" class="class-2">
        </div>

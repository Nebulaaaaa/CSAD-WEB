...
function disptopics($cid,$scid) {
     ...
     echo "<table calss='topics-table'>";
     echo "<tr><th>Title</th><th>Posted By</th><th>Date Posted</th><th>Views</th><th>Replies</th></tr>";
        while($row = mysqli_fetch_assoc($select))
        {
            echo "<tr><td><a href='/CSADWeb/readtopic.php?cid=".$cid."&scid=".$scid."&tid=".$row['topic_id']."'>
      ...
      echo "<p>this category has no topics yet!<a href='/CSADWeb/newtopic.php?cid=".$cid."&scid=".$scid."'>
       add the first topic you noob iian!</a></p>";
...
function replylink($cid, $scid, $tid) {
		echo "<p><a href='/CSADWeb/replyto.php?cid=".$cid."&scid=".$scid."&tid=".$tid."'>Reply to this post</a></p>";
	}
